...
def createTeam(firstIndex, secondIndex, isRed,
               first = 'ExpectimaxOffensiveAgent', second = 'DefensiveReflexAgent'):
  """
...
DEPTH = 8 # adversarial search tree depth

class SearchCaptureAgent(CaptureAgent):
  """
...
class ExpectimaxOffensiveAgent(SearchCaptureAgent):
